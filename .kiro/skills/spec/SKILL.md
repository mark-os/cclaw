---
name: spec
description: Create, amend, or backprop bugs into SPEC.md at repo root. Sole mutator of the project spec. Triggers when user asks to write a spec, start a new spec, distill from code, add invariants, amend sections, or record a bug. Reads FORMAT.md for caveman encoding rules.
---

# spec — spec mutator

Read `.kiro/skills/spec/FORMAT.md` if not already loaded. Caveman skill applies to all writes here.
