...
T301|.|sandbox w/ `unshare` — tool children: `unshare(CLONE_NEWNS\|CLONE_NEWPID\|CLONE_NEWNET)`; network via existing proxy model; per-agent config `sandbox = "sandbox"\|"none"`; remove all landlock/seccomp code|V22a,V37
