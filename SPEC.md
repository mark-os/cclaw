...
T302|.|remove old code — `request_stream.c`, in-process agent loop, old tool dispatch, cJSON in response/tool-arg parsing, multi-DB open logic, landlock/seccomp; clean build, all tests pass|T294,T295,T296,T297,T299,T300,T301
