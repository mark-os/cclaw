...
void print_usage(void) {
    printf("usage: cclaw [options]\n"
           ...
           "                                   swaps atomically, then signals the daemon to\n"
           "                                   re-exec into it (same pid, no supervisor\n"
           "                                   involved); update.restart_command overrides.\n"
           "                                   Reverts the binary if it does not come back.\n"
