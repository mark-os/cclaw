/*
 * Stdlib generator for the eval profile (forked sandboxed evaluator).
 * Emits symbol: js_std_library_eval
 */
#include <stdio.h>
#include <string.h>
...
{
    return build_atoms("js_std_library_eval", js_global_object, js_c_function_decl, argc, argv);
}
