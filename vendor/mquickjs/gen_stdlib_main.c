/*
 * Stdlib generator for the main profile (tool_js.c).
 * Emits symbol: js_std_library_main
 */
#include <stdio.h>
#include <string.h>
...
static const JSPropDef js_global_object[] = {
    ...
    JS_CFUNC_DEF("callTool", 2, js_callTool ),
...
{
    return build_atoms("js_std_library_main", js_global_object, js_c_function_decl, argc, argv);
}
